...
type JobDao interface {
	...
	GetJobInfo(name string, uid int) (info *typo.JobInfo, e error)
	UpdateJobInfo(name string, uid int, info *typo.JobInfo) (infoUpdated *typo.JobInfo, e error)
	DeleteJobInfo(name string, uid int) error
}
...
func (j *jobDao) GetJobInfo(name string, uid int) (info *typo.JobInfo, e error) {
...
func (j *jobDao) UpdateJobInfo(name string, uid int, info *typo.JobInfo) (infoUpdated *typo.JobInfo, e error) {
	cTime := time.Now()
	switch info.Status {
...
func (j *jobDao) DeleteJobInfo(name string, uid int) error {
